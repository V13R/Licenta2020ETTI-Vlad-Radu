...
# build context
path = Path("D:\OneDrive\Education\College\Licenta\RecSys - Data Sets")
in_path = str(path / "old_endomondoHR_proper.json")
def process(line):
    return eval(line)
"""
Vezi ce scoti de aici
pool = Pool(5)
...
with open(in_path,'r') as f:
    for line in f:
        ...
        i+=1;
        if i == 20000:            #TODO aici stabilim cate linii luam in setul de date...
            break
...
with open('D:/OneDrive/Education/College/Licenta/RecSys - Data Sets/endomondoHR_proper_temporal_dataset.pkl', 'wb') as f:
